...
sender = st.text_input("Enter the transaction sender:")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = st.text_input("Enter the transaction receiver:")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount = st.text_input("Enter the transaction amount:")
